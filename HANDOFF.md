...
## [2026-06-02 02:20] -- Novos m�dulos E2E exploit para firewalls (7 m�dulos)

### Estado ao encerrar
- Criados 7 novos m�dulos de exploit E2E em embedxpl/modules/exploits/firewalls/
- Arquivos modificados:
...
- Revisar os m�dulos em ambiente controlado e validar comportamento de check()/run() contra inst�ncias de teste

### Pend�ncias conhecidas
- [ ] Teste funcional em lab com appliances FortiOS/Citrix/Cisco simulados
- [ ] Adi��o de suporte a shell staging via embedxpl.core.shells quando confirmado RCE
- [ ] Atualizar __init__.py dos diret�rios se necess�rio para registro autom�tico dos m�dulos

### Ambiente necess�rio
- Python 3.10+
- embedxpl instalado (pip install -e . na raiz do EmbedXPL-Forge)
- Acesso de rede aos appliances-alvo em ambiente de laborat�rio isolado
...
### Pendencias conhecidas
- [ ] fortimanager_fortijump_cve_2024_47575.py (existente) ainda e stub basico -- pode ser expandido com l�gica da nova versao
...
- FASE 3: Kapsch RSU (kapsch_rsu_efi_shell_cve_2025_25734.py) complementado com check() e run() - interfa�e padr�o de exploit
...
- FirewallXPL-Forge: 14 modulos removidos de perimeter/lb, perimeter/waf, perimeter/nac (c�pias do sync que duplicavam originais em lb/, waf/, nac/)
- FirewallXPL-Forge: diret�rio perimeter/phoenix/ removido (nome errado; canonical � phoenix_contact/)
- FirewallXPL-Forge: fortimanager_fortijump movido para perimeter/fortinet/ (removido do routing/fortinet/)
- IndustrialXPL-Forge: 31 m�dulos removidos de protocols/ics/ (duplicavam plc/, rtos/, scada/, protocols/modbus/)
...
- EmbedXPL-Forge: check() adicionado a 11 modulos sem o m�todo: firmware_crypto_key_extract, 5 BLE/WiFi lab modules, 5 router exploits (dsl_2640b, wdr5620, wr849n, tew_651br, vmg8825)
...
### Pr�ximo passo imediato
- Nenhum pendente -- todos os repos est�o limpos e sem duplicatas

### Pend�ncias conhecidas
- FirewallXPL tem 32 conflicts reportados pelo sync (vers�es divergentes entre EmbedXPL e FW originais) -- comportamento esperado, sem a��o necess�ria
- cosmicenergy_iec104.py em IndustrialXPL existe em cve/malware/ e cve/malware/_native/ com conte�do diferente -- intencional (m�dulo wrapper + implementa��o nativa)
